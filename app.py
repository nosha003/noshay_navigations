...
if page == "Coaching":
    ...
    st.markdown(f"""
            <div class="price-card-container">
                <div style="color: var(--accent-green); font-size: 36px; font-weight: 700;">$150 <span style="font-size:18px; font-weight:400; color: var(--text-body); opacity: 0.7;">/ month</span></div>
